...
export class MatrixSdkViewModel implements IModuleViewModel {
  private static instance: MatrixSdkViewModel;
  ...
  public static getInstance(): MatrixSdkViewModel {
    if (!MatrixSdkViewModel.instance) {
      MatrixSdkViewModel.instance = new MatrixSdkViewModel();
    }
    return MatrixSdkViewModel.instance;
  }
