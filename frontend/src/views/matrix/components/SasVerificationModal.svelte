...
<Modal
  ...
  ariaLabelledby="sas-verification-title"
  containerClass="relative w-full max-w-md rounded-lg bg-white p-6 shadow-lg outline-none focus:outline-none dark:bg-gray-800"
>
  {#if sas}
    <h2 id="sas-verification-title" class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">
      Verify Emoji
    </h2>
