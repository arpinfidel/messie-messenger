...
abstract class AppLocalizations {
  ...
  /// No description provided for @emulator_host_rewrite.
  ///
  /// In en, this message translates to:
  /// **'Using 10.0.2.2 to reach host from Android emulator'**
  String get emulator_host_rewrite;

  /// No description provided for @login_privacyNote.
  ///
  /// In en, this message translates to:
  /// **'Matrix credentials never leave your device.'**
  String get login_privacyNote;

  /// No description provided for @messages_count.
  ///
  /// In en, this message translates to:
  /// **'{howMany, plural, =0{No messages} one{1 message} other{{howMany} messages}}'**
